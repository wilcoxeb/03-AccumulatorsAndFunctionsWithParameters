...
#              Point (0,0) is in the top left corner of the page
#
...
#            Render tells the program to draw the items in the window that has been set.
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#           It is necessary anytime you want to see what you have coded because if it is not there then the code
#           will run and the output will close instantly after the code has finished running and no one
# would be able to see what occurred.
